...
include::{snippets}/auth-controller-test/get-chatting-token/auto-section.adoc[]

include::{snippets}/auth-controller-test/get-chatting-token-with-invalid-user-token/http-response.adoc[]

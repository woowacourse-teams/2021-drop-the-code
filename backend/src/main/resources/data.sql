...
VALUES (CURRENT_DATE(), CURRENT_DATE(), 'seed@gmail.com', 'https://avatars.githubusercontent.com/u/56301069?v=4', 'Seed', 'TEACHER');

INSERT INTO member (created_at, updated_at, email, image_url, name, role)
VALUES (CURRENT_DATE(), CURRENT_DATE(), 'allie@gmail.com', 'https://avatars.githubusercontent.com/u/32974201?v=4', 'Allie', 'TEACHER');

INSERT INTO member (created_at, updated_at, email, image_url, name, role)
VALUES (CURRENT_DATE(), CURRENT_DATE(), 'bran@gmail.com', 'https://avatars.githubusercontent.com/u/52202474?v=4', 'Bran', 'TEACHER');

INSERT INTO member (created_at, updated_at, email, image_url, name, role)
VALUES (CURRENT_DATE(), CURRENT_DATE(), 'air@gmail.com', 'https://avatars.githubusercontent.com/u/45876793?v=4', 'Air', 'TEACHER');

INSERT INTO member (created_at, updated_at, email, image_url, name, role)
VALUES (CURRENT_DATE(), CURRENT_DATE(), 'fafi@gmail.com', 'https://avatars.githubusercontent.com/u/50273712?v=44', 'Fafi', 'TEACHER');

INSERT INTO member (created_at, updated_at, email, image_url, name, role)
VALUES (CURRENT_DATE(), CURRENT_DATE(), '1219ssm@gmail.com', 'https://avatars.githubusercontent.com/u/50273712?v=44', 'Shinsehantan', 'TEACHER');


INSERT INTO teacher_profile (member_id, created_at, updated_at, career, content, title, sum_review_count, average_review_time)
VALUES (1, CURRENT_DATE(), CURRENT_DATE(), 5, '배민 1타 강사. 롤체 챌 출신. 열심히 가르쳐드리겠습니다.', '배민 출신 백엔드 개발자', 2, 1.3);
INSERT INTO teacher_profile (member_id, created_at, updated_at, career, content, title, sum_review_count, average_review_time)
VALUES (2, CURRENT_DATE(), CURRENT_DATE(), 4, '빡세게 가르쳐드리겠습니다.', '쿠팡 이츠 출신 백엔드 개발자', 5, 1.2);
INSERT INTO teacher_profile (member_id, created_at, updated_at, career, content, title, sum_review_count, average_review_time)
VALUES (3, CURRENT_DATE(), CURRENT_DATE(), 10, '열심히 하겠습니다.', '우테코 갓 졸업생', 10, 5.3);
INSERT INTO teacher_profile (member_id, created_at, updated_at, career, content, title, sum_review_count, average_review_time)
VALUES (4, CURRENT_DATE(), CURRENT_DATE(), 2, '화이팅', '배민 인프라 담당자', 1, 10.1);
INSERT INTO teacher_profile (member_id, created_at, updated_at, career, content, title, sum_review_count, average_review_time)
VALUES (5, CURRENT_DATE(), CURRENT_DATE(), 7, '실리콘밸리 출신 인프라 개발자. 영어로 수업합니다.', 'Amazon 서버 개발자', 3, 2.9);
INSERT INTO teacher_profile (member_id, created_at, updated_at, career, content, title, sum_review_count, average_review_time)
VALUES (6, CURRENT_DATE(), CURRENT_DATE(), 6, '화이팅', '배민 프론트 개발자', 1, 8.4);
...
VALUES (CURRENT_DATE(), CURRENT_DATE(), 'Spark에서 Spring으로 마이그레이션', 48, 'github.com/pr/1', 'FINISHED', '자동차 경주 리뷰 요청', 1, 2);
